...
// question 1
const random = ("Hello World, Today Is Thursday")
console.log(random.length);
// // question 2
const fruits = ["Fruits", "Meat", "Vegetables"]
// // question 3
console.log(fruits.pop(0,1));
// // question 4
const upper = ("XL");
...
// // question 6
const arr = "Fruits, Meat, Vegetables";
let vegan = arr.replace("Meat", "Tree")
console.log(vegan);
